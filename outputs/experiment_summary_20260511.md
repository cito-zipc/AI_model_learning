...
|---|---|---|---:|---:|---:|---:|---:|---|---|
|CIFAR100|なし|Net4 (Conv 3->32->64, FC 64x6x6->256->100, Dropout 0.5)|50|Adamデフォルト|0.3526|2.223766|2.648635|![cifar100_net4](figures/cifar100_net4.png)|ノイズ無によりtrainデータが順調に学習されている|
...
|CIFAR100|Erasing|Net4 (Conv 3->32->64, FC 64x6x6->256->100, Dropout 0.5)|50|Adamデフォルト|0.3809|2.389951|2.441662|![cifar100_net4_erasing](figures/cifar100_net4_erasing.png)|ノイズを小さくしたことによりtrainデータが順調に学習されている。accyracyが今回の中で一番高い|
|CIFAR100|Erasing（Normalize最適化、erasing率0.4）|Net4 (Conv 3->32->64, FC 64x6x6->256->100, Dropout 0.5)|100|Adamデフォルト|0.4484|1.816670|2.748098|![cifar100_net4_erasing_epoch100](figures/cifar100_net4_erasing_epoch100.png)|epochを100に増やすことでaccuracyは改善。ただしTestLossは50epoch版より増加し、過学習傾向が見られる|
