...
if __name__ == "__main__":
    checkpoint_path = CHECKPOINTS_DIR / "net4_cifar100_lr1e2_checkpoint.pt"
    legacy_checkpoint_path = PROJECT_ROOT / "results" / "net4_cifar100_lr1e2_checkpoint.pt"
    ...
    # 結果出力
    print("\n学習結果を表示します...")
    plot_loss_curve(record_loss_train, record_loss_test, save_path=FIGURES_DIR / "net4_cifar100_lr1e2_loss_curve.png")
