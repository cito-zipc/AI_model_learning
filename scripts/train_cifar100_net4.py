...
train_loader_100 = dataloaders["train_loader_100"]
...
def train_model():
    ...
    for i in range(NUM_EPOCHS):
        ...
        for j, (x, t) in enumerate(train_loader_100):
            x, t = x.cuda(), t.cuda()
            y = net(x)
            loss = loss_fnc(y, t)
...
if __name__ == "__main__":
    checkpoint_path = CHECKPOINTS_DIR / "net4_cifar100_checkpoint.pt"
    legacy_checkpoint_path = PROJECT_ROOT / "results" / "net4_cifar100_checkpoint.pt"
    ...
    # 結果出力
    print("\n学習結果を表示します...")
    plot_loss_curve(record_loss_train, record_loss_test, save_path=FIGURES_DIR / "cifar100_net4.png")
