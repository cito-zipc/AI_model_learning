...
def create_cifar_datasets(data_dir=DATA_DIR, transforms_map=None):
...
def create_cifar_dataloaders(batch_size=64, data_dir=DATA_DIR, transforms_map=None):
    datasets = create_cifar_datasets(data_dir=data_dir, transforms_map=transforms_map)

    return {
        "train_loader": DataLoader(datasets["cifar10_train"], batch_size=batch_size, shuffle=True),
        "train_loader_erasing": DataLoader(datasets["cifar10_train_erasing"], batch_size=batch_size, shuffle=True),
        "train_loader_random": DataLoader(datasets["cifar10_train_random"], batch_size=batch_size, shuffle=True),
        "test_loader": DataLoader(datasets["cifar10_test"], batch_size=batch_size, shuffle=False),
        "train_loader_100": DataLoader(datasets["cifar100_train"], batch_size=batch_size, shuffle=True),
        "train_loader_erasing_100": DataLoader(datasets["cifar100_train_erasing"], batch_size=batch_size, shuffle=True),
        "train_loader_random_100": DataLoader(datasets["cifar100_train_random"], batch_size=batch_size, shuffle=True),
        "test_loader_100": DataLoader(datasets["cifar100_test"], batch_size=batch_size, shuffle=False),
    }
