...
def create_cifar_datasets(data_dir="data/", transforms_map=None):
    ...
    return {
        "cifar10_train": CIFAR10(
            str(data_dir), train=True, download=True, transform=transforms_map["train"]
        ),
        "cifar10_train_erasing": CIFAR10(
            str(data_dir), train=True, download=True, transform=transforms_map["train_erasing"]
        ),
        "cifar10_train_random": CIFAR10(
            str(data_dir), train=True, download=True, transform=transforms_map["train_random"]
        ),
        "cifar10_test": CIFAR10(
            str(data_dir), train=False, download=True, transform=transforms_map["test"]
        ),
        "cifar100_train": CIFAR100(
            str(data_dir), train=True, download=True, transform=transforms_map["train"]
        ),
        "cifar100_train_erasing": CIFAR100(
            str(data_dir), train=True, download=True, transform=transforms_map["train_erasing"]
        ),
        "cifar100_train_random": CIFAR100(
            str(data_dir), train=True, download=True, transform=transforms_map["train_random"]
        ),
        "cifar100_train_crop": CIFAR100(
            str(data_dir), train=True, download=True, transform=transforms_map["train_crop"]
        ),
